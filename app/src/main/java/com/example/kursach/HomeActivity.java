...
import com.example.kursach.Model.Products;
import com.example.kursach.Prevalent.Prevalent;
import com.example.kursach.ViewHolder.ProductViewHolder;
...
//    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_korzina){
            Intent korzinaIntent = new Intent(HomeActivity.this,KorzinaActivity.class);
            startActivity(korzinaIntent);

        } else if(id == R.id.nav_categories){
            Intent categoriyIntent = new Intent(HomeActivity.this,CategoriyActivity.class);
            startActivity(categoriyIntent);

        } else if(id == R.id.nav_like){
            Intent likeIntent = new Intent(HomeActivity.this,LikeActivity.class);
